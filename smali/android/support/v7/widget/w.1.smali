...
# static fields
.field static final nJ:Ljava/lang/ThreadLocal;

.field static nN:Ljava/util/Comparator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/w;->nJ:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Landroid/support/v7/widget/w;->nN:Ljava/util/Comparator;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/w;->nK:Ljava/util/ArrayList;
...
.method private a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/aA;
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/widget/aq;->Y(Landroid/view/View;)V
...
.method final a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 178
    iget-wide v0, p0, Landroid/support/v7/widget/w;->nL:J
    ...
    iput-wide v0, p0, Landroid/support/v7/widget/w;->nL:J
    ...
    iput p2, p1, Landroid/support/v7/widget/y;->nO:I

    iput p3, p1, Landroid/support/v7/widget/y;->nP:I
...
.method public final run()V
    ...
    .line 373
    iget-object v0, v1, Landroid/support/v7/widget/w;->nK:Ljava/util/ArrayList;
    ...
    .line 400
    iput-wide v2, v1, Landroid/support/v7/widget/w;->nL:J
    ...
    .line 383
    iget-object v8, v1, Landroid/support/v7/widget/w;->nK:Ljava/util/ArrayList;
    ...
    iget-wide v7, v1, Landroid/support/v7/widget/w;->nM:J
    ...
    iget-object v9, v1, Landroid/support/v7/widget/w;->nK:Ljava/util/ArrayList;
    ...
    iget-object v10, v1, Landroid/support/v7/widget/w;->nK:Ljava/util/ArrayList;
    ...
    iget v12, v11, Landroid/support/v7/widget/y;->nO:I

    invoke-static {v12}, Ljava/lang/Math;->abs(I)I

    move-result v12

    iget v13, v11, Landroid/support/v7/widget/y;->nP:I
    ...
    :goto_4
    iget-object v15, v11, Landroid/support/v7/widget/y;->nQ:[I
    ...
    :goto_5
    iput-boolean v2, v14, Landroid/support/v7/widget/z;->nR:Z

    iput v12, v14, Landroid/support/v7/widget/z;->nS:I

    iput v15, v14, Landroid/support/v7/widget/z;->nT:I

    iput-object v10, v14, Landroid/support/v7/widget/z;->nU:Landroid/support/v7/widget/RecyclerView;

    iget-object v2, v11, Landroid/support/v7/widget/y;->nQ:[I
    ...
    sget-object v2, Landroid/support/v7/widget/w;->nN:Ljava/util/Comparator;
    ...
    iget-object v3, v2, Landroid/support/v7/widget/z;->nU:Landroid/support/v7/widget/RecyclerView;

    if-eqz v3, :cond_f

    iget-boolean v3, v2, Landroid/support/v7/widget/z;->nR:Z
    ...
    invoke-virtual {v7}, Landroid/support/v7/widget/d;->bc()I
    ...
    invoke-static {v8}, Landroid/support/v4/os/e;->beginSection(Ljava/lang/String;)V

    iget-object v8, v3, Landroid/support/v7/widget/RecyclerView;->mState:Landroid/support/v7/widget/ax;

    iget-object v10, v3, Landroid/support/v7/widget/RecyclerView;->mAdapter:Landroid/support/v7/widget/V;

    iput v9, v8, Landroid/support/v7/widget/ax;->pn:I

    invoke-virtual {v10}, Landroid/support/v7/widget/V;->getItemCount()I

    move-result v10

    iput v10, v8, Landroid/support/v7/widget/ax;->po:I

    iput-boolean v4, v8, Landroid/support/v7/widget/ax;->pq:Z

    iput-boolean v4, v8, Landroid/support/v7/widget/ax;->pr:Z

    iput-boolean v4, v8, Landroid/support/v7/widget/ax;->ps:Z
    ...
    iget-object v10, v7, Landroid/support/v7/widget/y;->nQ:[I
    ...
    :cond_e
    :goto_9
    iput-boolean v4, v2, Landroid/support/v7/widget/z;->nR:Z

    iput v4, v2, Landroid/support/v7/widget/z;->nS:I

    iput v4, v2, Landroid/support/v7/widget/z;->nT:I

    const/4 v3, 0x0

    iput-object v3, v2, Landroid/support/v7/widget/z;->nU:Landroid/support/v7/widget/RecyclerView;
