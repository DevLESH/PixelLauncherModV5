...
.method public final generateWidgetPreview(Lcom/android/launcher3/BaseActivity;Lcom/android/launcher3/LauncherAppWidgetProviderInfo;ILandroid/graphics/Bitmap;[I)Landroid/graphics/Bitmap;
    ...
    .line 317
    :goto_0
    iget v0, v3, Lcom/android/launcher3/LauncherAppWidgetProviderInfo;->previewImage:I
    ...
    invoke-virtual {v3, v0, v8}, Lcom/android/launcher3/LauncherAppWidgetProviderInfo;->loadPreviewImage(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    const-string v11, "Error loading widget preview for: "

    invoke-direct {v10, v11}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v11, v3, Lcom/android/launcher3/LauncherAppWidgetProviderInfo;->provider:Landroid/content/ComponentName;
    ...
    iget v11, v3, Lcom/android/launcher3/LauncherAppWidgetProviderInfo;->previewImage:I
    ...
    :goto_3
    iget v11, v3, Lcom/android/launcher3/LauncherAppWidgetProviderInfo;->spanX:I

    .line 336
    iget v12, v3, Lcom/android/launcher3/LauncherAppWidgetProviderInfo;->spanY:I
    ...
    .line 345
    :cond_4
    iget-object v13, v2, Lcom/android/launcher3/BaseActivity;->mDeviceProfile:Lcom/android/launcher3/DeviceProfile;

    .line 346
    iget v14, v13, Lcom/android/launcher3/DeviceProfile;->cellWidthPx:I

    iget v13, v13, Lcom/android/launcher3/DeviceProfile;->cellHeightPx:I
    ...
    invoke-virtual {v4, v15, v14, v7}, Landroid/graphics/Bitmap;->reconfigure(IILandroid/graphics/Bitmap$Config;)V
    ...
    invoke-virtual {v0, v7, v8, v13, v14}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    .line 388
    :cond_a
    invoke-virtual {v1, v5, v13, v14}, Lcom/android/launcher3/WidgetPreviewLoader;->drawBoxWithShadow(Landroid/graphics/Canvas;II)Landroid/graphics/RectF;
    ...
    .line 393
    iget-object v8, v1, Lcom/android/launcher3/WidgetPreviewLoader;->mContext:Landroid/content/Context;
    ...
    iget-object v8, v3, Lcom/android/launcher3/LauncherAppWidgetProviderInfo;->provider:Landroid/content/ComponentName;
    ...
    iget v3, v3, Lcom/android/launcher3/LauncherAppWidgetProviderInfo;->icon:I

    invoke-virtual {v7, v8, v3}, Lcom/android/launcher3/IconCache;->getFullResIcon(Ljava/lang/String;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 420
    invoke-virtual {v1, v3}, Lcom/android/launcher3/WidgetPreviewLoader;->mutateOnMainThread(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v13, v14, v2, v0}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
