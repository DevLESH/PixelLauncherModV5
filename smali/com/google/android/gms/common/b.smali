...
# static fields
.field private static final AY:Lcom/google/android/gms/common/b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/common/b;->AY:Lcom/google/android/gms/common/b;

    sget v0, Lcom/google/android/gms/common/d;->AZ:I

    sput v0, Lcom/google/android/gms/common/b;->AZ:I
...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/internal/bP;)Lcom/google/android/gms/internal/bO;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/internal/bP;->fW()V
...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/h;->a(Landroid/support/v4/app/w;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-static {}, Lcom/google/android/gms/common/a/k;->fj()Z
    ...
    invoke-direct {v4, p1}, Landroid/support/v4/app/ap;-><init>(Landroid/content/Context;)V

    iget-object v5, v4, Landroid/support/v4/app/ap;->gP:Landroid/app/Notification;
    ...
    invoke-virtual {v4, v3}, Landroid/support/v4/app/ap;->d(Ljava/lang/CharSequence;)Landroid/support/v4/app/ap;
    ...
    iget-object v6, v3, Landroid/support/v4/app/ap;->gP:Landroid/app/Notification;

    iput-wide v4, v6, Landroid/app/Notification;->when:J

    iget-object v4, v3, Landroid/support/v4/app/ap;->gP:Landroid/app/Notification;
    ...
    iput-object p3, v3, Landroid/support/v4/app/ap;->gj:Landroid/app/PendingIntent;

    invoke-virtual {v3, v1}, Landroid/support/v4/app/ap;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/ap;

    move-result-object p3

    invoke-virtual {p3, v2}, Landroid/support/v4/app/ap;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/ap;

    move-result-object p3

    iput-boolean v0, p3, Landroid/support/v4/app/ap;->gB:Z
    ...
    invoke-virtual {p3, v0}, Landroid/support/v4/app/ap;->a(Landroid/support/v4/app/aq;)Landroid/support/v4/app/ap;

    move-result-object p3

    new-instance v0, Landroid/support/v4/app/ar;

    invoke-direct {v0, p3}, Landroid/support/v4/app/ar;-><init>(Landroid/support/v4/app/ap;)V

    invoke-virtual {v0}, Landroid/support/v4/app/ar;->build()Landroid/app/Notification;
    ...
    sget-object v0, Lcom/google/android/gms/common/f;->Bh:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static eb()Lcom/google/android/gms/common/b;
    .locals 1

    sget-object v0, Lcom/google/android/gms/common/b;->AY:Lcom/google/android/gms/common/b;
...
.method public final a(Landroid/content/Context;Lcom/google/android/gms/common/ConnectionResult;I)Z
    ...
    iget-object v0, p2, Lcom/google/android/gms/common/ConnectionResult;->AV:Landroid/app/PendingIntent;

    goto :goto_0

    :cond_0
    iget v0, p2, Lcom/google/android/gms/common/ConnectionResult;->AU:I
...
.method public final ax(I)Z
    .locals 0

    invoke-super {p0, p1}, Lcom/google/android/gms/common/d;->ax(I)Z
...
.method public final ay(I)Landroid/content/Intent;
    .locals 0

    invoke-super {p0, p1}, Lcom/google/android/gms/common/d;->ay(I)Landroid/content/Intent;
...
.method public final az(I)Ljava/lang/String;
    .locals 0

    invoke-super {p0, p1}, Lcom/google/android/gms/common/d;->az(I)Ljava/lang/String;
...
.method public final r(Landroid/content/Context;)I
    ...
    invoke-super {p0, p1}, Lcom/google/android/gms/common/d;->r(Landroid/content/Context;)I
