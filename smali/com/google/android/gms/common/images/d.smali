...
.method public constructor <init>(Lcom/google/android/gms/common/images/ImageManager;Landroid/net/Uri;Landroid/graphics/Bitmap;ZLjava/util/concurrent/CountDownLatch;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/images/d;->CG:Lcom/google/android/gms/common/images/ImageManager;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lcom/google/android/gms/common/images/d;->mUri:Landroid/net/Uri;

    iput-object p3, p0, Lcom/google/android/gms/common/images/d;->mBitmap:Landroid/graphics/Bitmap;

    iput-boolean p4, p0, Lcom/google/android/gms/common/images/d;->CJ:Z

    iput-object p5, p0, Lcom/google/android/gms/common/images/d;->CI:Ljava/util/concurrent/CountDownLatch;
...
.method public final run()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/images/d;->mBitmap:Landroid/graphics/Bitmap;
    ...
    :goto_0
    iget-object v2, p0, Lcom/google/android/gms/common/images/d;->CG:Lcom/google/android/gms/common/images/ImageManager;
    ...
    iget-boolean v2, p0, Lcom/google/android/gms/common/images/d;->CJ:Z

    if-eqz v2, :cond_2

    iget-object v0, p0, Lcom/google/android/gms/common/images/d;->CG:Lcom/google/android/gms/common/images/ImageManager;
    ...
    iput-boolean v1, p0, Lcom/google/android/gms/common/images/d;->CJ:Z
    ...
    iget-object v4, p0, Lcom/google/android/gms/common/images/d;->mUri:Landroid/net/Uri;

    invoke-direct {v3, v4}, Lcom/google/android/gms/common/images/f;-><init>(Landroid/net/Uri;)V

    iget-object v4, p0, Lcom/google/android/gms/common/images/d;->mBitmap:Landroid/graphics/Bitmap;
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/images/d;->mUri:Landroid/net/Uri;
    ...
    iget-object v5, p0, Lcom/google/android/gms/common/images/d;->CG:Lcom/google/android/gms/common/images/ImageManager;
    ...
    iget-object v6, p0, Lcom/google/android/gms/common/images/d;->mBitmap:Landroid/graphics/Bitmap;
    ...
    iget-object v6, p0, Lcom/google/android/gms/common/images/d;->mUri:Landroid/net/Uri;
    ...
    iget-object v6, p0, Lcom/google/android/gms/common/images/d;->CG:Lcom/google/android/gms/common/images/ImageManager;

    invoke-static {v6}, Lcom/google/android/gms/common/images/ImageManager;->c(Lcom/google/android/gms/common/images/ImageManager;)Lcom/google/android/gms/internal/cA;

    invoke-virtual {v4, v5}, Lcom/google/android/gms/common/images/e;->w(Landroid/content/Context;)V
    ...
    :cond_6
    iget-object v0, p0, Lcom/google/android/gms/common/images/d;->CI:Ljava/util/concurrent/CountDownLatch;

    invoke-virtual {v0}, Ljava/util/concurrent/CountDownLatch;->countDown()V

    invoke-static {}, Lcom/google/android/gms/common/images/ImageManager;->ev()Ljava/lang/Object;
    ...
    :try_start_0
    invoke-static {}, Lcom/google/android/gms/common/images/ImageManager;->ew()Ljava/util/HashSet;

    move-result-object v1

    iget-object v2, p0, Lcom/google/android/gms/common/images/d;->mUri:Landroid/net/Uri;
